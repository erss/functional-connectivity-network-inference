%MAK:  subtract the *mean* of the signal before computing the coherence.

function [C,phi,S12,S1,S2,t,f,confC,phistd,Cerr]=cohgramc_MAK(data1,data2,movingwin,params)
...
for n=1:nw;
   ...
   datawin1=datawin1-mean(datawin1);
   datawin2=datawin2-mean(datawin2);
   if nargout==10;
